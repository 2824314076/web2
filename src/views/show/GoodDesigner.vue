<template>
  <div class="main">
    <div>
      ...
      <el-row>
        <el-col :span="8" v-for="(item, index) in designers" :key="index"
                style="width:30%;margin-left:20px;cursor: pointer;">
...
export default {
  ...
  methods: {
    open(id) {
      ...
      sessionStorage.setItem("url", '/prod-api/designerIntroduce/get?id=' + id)
